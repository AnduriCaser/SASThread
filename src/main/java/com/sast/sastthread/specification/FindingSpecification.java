...
public class FindingSpecification implements Specification<Finding> {

    private final SearchCriteria searchCriteria;

    public FindingSpecification(final SearchCriteria searchCriteria) {
        super();
    ...
    @Nullable
    @Override
    public Predicate toPredicate(Root<Finding> root,
